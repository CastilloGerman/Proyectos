...
export const routes: Routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'gastos', loadComponent: () => import('./features/gastos/gasto-list/gasto-list.component').then(m => m.GastoListComponent) },
      { path: 'gastos/nuevo', canActivate: [roleMutateGuard], loadComponent: () => import('./features/gastos/gasto-form/gasto-form.component').then(m => m.GastoFormComponent) },
      { path: 'gastos/:id', canActivate: [roleMutateGuard], loadComponent: () => import('./features/gastos/gasto-form/gasto-form.component').then(m => m.GastoFormComponent) },

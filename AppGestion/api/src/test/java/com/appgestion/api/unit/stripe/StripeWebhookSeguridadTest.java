...
class StripeWebhookSeguridadTest {
    ...
    @Test
    void webhookConFalloProcesamiento_devuelve500ParaReintentoStripe() throws Exception {
        when(stripeWebhookService.processWebhook(any(), any())).thenReturn(StripeWebhookProcessingResult.processingFailure());
